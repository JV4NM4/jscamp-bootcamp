...
export function Home() {
  // 1. Obtiene nuestra función de navegación del hook
  ...
  const handleSearch = (event) => {
    ...
    // Extrae el valor usando FormData
      ...
      <section>
        ...
        <footer>
          <article>
            ...
            <p>
              Busca miles de empleos en las mejores empresas de todo el mundo.
            </p>
          </article>
