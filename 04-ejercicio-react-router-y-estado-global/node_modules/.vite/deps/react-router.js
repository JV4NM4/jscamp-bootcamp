...
// node_modules/react-router/dist/development/lib/router/url.js
...
// node_modules/react-router/dist/development/lib/router/history.js
...
function createBrowserURLImpl(windowImpl, to, isAbsolute = false) {
  ...
  if (!isAbsolute && PROTOCOL_RELATIVE_URL_REGEX.test(href2)) href2 = base + href2;
  return new URL(href2, base);
}

// node_modules/react-router/dist/development/lib/router/utils.js
...
function generatePath(originalPath, params = {}) {
  ...
  return prefix + path.split(/\/+/).map((segment, index, array) => {
    if (index === array.length - 1 && segment === "*") return stringify3(params["*"]);
    const keyMatch = segment.match(/^:([\w-]+)(\??)(.*)/);
    if (keyMatch) {
      const [, key, optional, suffix] = keyMatch;
      let param = params[key];
      invariant(optional === "?" || param != null, `Missing ":${key}" param`);
      return encodePathParam(stringify3(param)) + suffix;
    }
...
// node_modules/react-router/dist/development/lib/router/instrumentation.js
...
function instrumentClientSideRouter(router, fns) {
  ...
  if (aggregated.fetch.length > 0) {
    let fetch2 = getUninstrumentedHandler(router.fetch);
    let instrumentedFetch = async (...args) => {
      let [key, _, href2, opts] = args;
      let meta;
...
// node_modules/react-router/dist/development/lib/router/navigation.js
...
// node_modules/react-router/dist/development/lib/router/router.js
...
function createRouter(init) {
  ...
  async function navigate(to, opts) {
    ...
    } else if (submission != null && isMutationMethod(submission.formMethod) && submission.formAction === state.location.pathname + state.location.search) historyAction = "REPLACE";
  ...
  async function handleAction(request, location, submission, matches, historyAction, scopedContext, isFogOfWar, initialHydration, opts = {}) {
    ...
    if (!actionMatch.route.action && !actionMatch.route.lazy) result = {
      ...
      let results = await callDataStrategy(request, location, getTargetedDataStrategyMatches(mapRouteProperties, manifest, request, location, matches, actionMatch, initialHydration ? [] : hydrationRouteProperties2, scopedContext), scopedContext, null);
  ...
  async function handleLoaders(request, location, matches, historyAction, scopedContext, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace2, initialHydration, flushSync, pendingActionResult, callSiteDefaultShouldRevalidate) {
    ...
    let routesToUse = dataRoutes.activeRoutes;
    let { dsMatches, revalidatingFetchers } = getMatchesToLoad(request, scopedContext, mapRouteProperties, manifest, init.history, state, matches, activeSubmission, location, initialHydration ? [] : hydrationRouteProperties2, initialHydration === true, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, init.patchRoutesOnNavigation != null, dataRoutes.branches, pendingActionResult, callSiteDefaultShouldRevalidate);
  ...
  async function handleFetcherAction(key, routeId, path, requestMatches, scopedContext, isFogOfWar, flushSync, preventScrollReset, submission, callSiteDefaultShouldRevalidate) {
    ...
    let fetchMatches = getTargetedDataStrategyMatches(mapRouteProperties, manifest, fetchRequest, path, requestMatches, match, hydrationRouteProperties2, scopedContext);
  ...
  async function handleFetcherLoader(key, routeId, path, matches, scopedContext, isFogOfWar, flushSync, preventScrollReset, submission) {
    ...
    fetchControllers.set(key, abortController);
    let originatingLoadId = incrementingLoadId;
    let results = await callDataStrategy(fetchRequest, path, getTargetedDataStrategyMatches(mapRouteProperties, manifest, fetchRequest, path, matches, match, hydrationRouteProperties2, scopedContext), scopedContext, key);
...
async function callRouteMiddleware(args, middlewares, handler, processResult, isResult, errorHandler, idx = 0) {
  let { request } = args;
  if (request.signal.aborted) throw request.signal.reason ?? new Error(`Request aborted: ${request.method} ${request.url}`);
...
// node_modules/react-router/dist/development/lib/context.js
var React$12 = __toESM(require_react(), 1);
var DataRouterContext = React$12.createContext(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = React$12.createContext(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = React$12.createContext(false);
function useIsRSCRouterContext() {
  return React$12.useContext(RSCRouterContext);
}
var ViewTransitionContext = React$12.createContext({ isTransitioning: false });
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = React$12.createContext(/* @__PURE__ */ new Map());
FetchersContext.displayName = "Fetchers";
var AwaitContext = React$12.createContext(null);
AwaitContext.displayName = "Await";
var AwaitContextProvider = (props) => React$12.createElement(AwaitContext.Provider, props);
var NavigationContext = React$12.createContext(null);
NavigationContext.displayName = "Navigation";
var LocationContext = React$12.createContext(null);
LocationContext.displayName = "Location";
var RouteContext = React$12.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
RouteContext.displayName = "Route";
var RouteErrorContext = React$12.createContext(null);
RouteErrorContext.displayName = "RouteError";

// node_modules/react-router/dist/development/lib/errors.js
...
// node_modules/react-router/dist/development/lib/hooks.js
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator } = React$13.useContext(NavigationContext);
...
function useNavigationType() {
  return React$13.useContext(LocationContext).navigationType;
}
function useMatch(pattern) {
  invariant(useInRouterContext(), `useMatch() may be used only in the context of a <Router> component.`);
  let { pathname } = useLocation();
  return React$13.useMemo(() => matchPath(pattern, decodePath(pathname)), [pathname, pattern]);
}
...
function useNavigateUnstable() {
  ...
  let activeRef = React$13.useRef(false);
  React$13.useLayoutEffect(() => {
    activeRef.current = true;
  });
  return React$13.useCallback((to, options = {}) => {
...
var OutletContext = React$13.createContext(null);
function useOutletContext() {
  return React$13.useContext(OutletContext);
}
function useOutlet(context) {
  let outlet = React$13.useContext(RouteContext).outlet;
  return React$13.useMemo(() => outlet && React$13.createElement(OutletContext.Provider, { value: context }, outlet), [outlet, context]);
}
function useParams() {
  let { matches } = React$13.useContext(RouteContext);
...
function useResolvedPath(to, { relative } = {}) {
  ...
  let { pathname: locationPathname } = useLocation();
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
  return React$13.useMemo(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [
    to,
    routePathnamesJson,
    locationPathname,
    relative
...
function useRoutesImpl(routes, locationArg, dataRouterOpts) {
  ...
  let { matches: parentMatches } = React$13.useContext(RouteContext);
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
  ...
  if (locationArg && renderedMatches) return React$13.createElement(LocationContext.Provider, { value: {
    location: {
      pathname: "/",
      search: "",
      hash: "",
...
function DefaultErrorComponent() {
  ...
  devInfo = React$13.createElement(React$13.Fragment, null, React$13.createElement("p", null, "💿 Hey developer 👋"), React$13.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", React$13.createElement("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", React$13.createElement("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  return React$13.createElement(React$13.Fragment, null, React$13.createElement("h2", null, "Unexpected Application Error!"), React$13.createElement("h3", { style: { fontStyle: "italic" } }, message), stack ? React$13.createElement("pre", { style: preStyles }, stack) : null, devInfo);
}
var defaultErrorElement = React$13.createElement(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends React$13.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let result = error !== void 0 ? React$13.createElement(RouteContext.Provider, { value: this.props.routeContext }, React$13.createElement(RouteErrorContext.Provider, {
      value: error,
      children: this.props.component
    })) : this.props.children;
    if (this.context) return React$13.createElement(RSCErrorHandler, { error }, result);
    return result;
  }
};
...
function RSCErrorHandler({ children, error }) {
  ...
  if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
    ...
    if (redirect2) {
      ...
      return React$13.createElement("meta", {
        httpEquiv: "refresh",
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return React$13.createElement(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => {
      ...
      else if (match.route.Component) children = React$13.createElement(match.route.Component, null);
      else if (match.route.element) children = match.route.element;
      else children = outlet;
      return React$13.createElement(RenderedRoute, {
        match,
        routeContext: {
          outlet,
          matches: matches2,
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? React$13.createElement(RenderErrorBoundary, {
      location: dataRouterState.location,
...
function useRevalidator() {
  ...
  let revalidate = React$13.useCallback(async () => {
...
function useAsyncValue() {
  return React$13.useContext(AwaitContext)?._data;
}
function useAsyncError() {
  return React$13.useContext(AwaitContext)?._error;
}
var blockerId = 0;
function useBlocker(shouldBlock) {
  let { router, basename } = useDataRouterContext("useBlocker");
  let state = useDataRouterState("useBlocker");
  let [blockerKey, setBlockerKey] = React$13.useState("");
  let blockerFunction = React$13.useCallback((arg) => {
...
function useNavigateStable() {
  ...
  return React$13.useCallback(async (to, options = {}) => {
    warning(activeRef.current, navigateEffectWarning);
    if (!activeRef.current) return;
...
// node_modules/react-router/dist/development/lib/server-runtime/warnings.js
var alreadyWarned2 = {};
...
// node_modules/react-router/dist/development/lib/components.js
...
function RouterProvider({ router, flushSync: reactDomFlushSyncImpl, onError, useTransitions }) {
  ...
  let [_state, setStateImpl] = React$14.useState(router.state);
  let [state, setOptimisticState] = (0, import_react.useOptimistic)(_state);
  let [pendingState, setPendingState] = React$14.useState();
  let [vtContext, setVtContext] = React$14.useState({ isTransitioning: false });
  let [renderDfd, setRenderDfd] = React$14.useState();
  let [transition, setTransition] = React$14.useState();
  let [interruption, setInterruption] = React$14.useState();
  let fetcherData = React$14.useRef(/* @__PURE__ */ new Map());
  let setState = React$14.useCallback((newState, { deletedFetchers, newErrors, flushSync, viewTransitionOpts }) => {
  ...
  React$14.useLayoutEffect(() => router.subscribe(setState), [router, setState]);
  React$14.useEffect(() => {
  ...
  let navigator = React$14.useMemo(() => {
    return {
  ...
  let dataRouterContext = React$14.useMemo(() => ({
    router,
    navigator,
    static: false,
    basename,
  ...
  return React$14.createElement(React$14.Fragment, null, React$14.createElement(DataRouterContext.Provider, { value: dataRouterContext }, React$14.createElement(DataRouterStateContext.Provider, { value: state }, React$14.createElement(FetchersContext.Provider, { value: fetcherData.current }, React$14.createElement(ViewTransitionContext.Provider, { value: vtContext }, React$14.createElement(Router, {
    basename,
    location: state.location,
    navigationType: state.historyAction,
    navigator,
    useTransitions
  }, React$14.createElement(MemoizedDataRoutes, {
...
var MemoizedDataRoutes = React$14.memo(DataRoutes2);
...
function MemoryRouter({ basename, children, initialEntries, initialIndex, useTransitions }) {
  let historyRef = React$14.useRef(null);
  ...
  let [state, setStateImpl] = React$14.useState({
    action: history.action,
    location: history.location
  });
  let setState = React$14.useCallback((newState) => {
    if (useTransitions === false) setStateImpl(newState);
    else React$14.startTransition(() => setStateImpl(newState));
  }, [useTransitions]);
  React$14.useLayoutEffect(() => history.listen(setState), [history, setState]);
  return React$14.createElement(Router, {
    basename,
    children,
    location: state.location,
...
function Navigate({ to, replace: replace2, state, relative }) {
  ...
  let { static: isStatic, navigator } = React$14.useContext(NavigationContext);
  warning(!isStatic, "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");
  let { matches } = React$14.useContext(RouteContext);
  let { pathname: locationPathname } = useLocation();
...
function Router({ basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP", navigator, static: staticProp = false, useTransitions }) {
  ...
  let navigationContext = React$14.useMemo(() => ({
    basename,
    navigator,
    static: staticProp,
    useTransitions,
  ...
  let locationContext = React$14.useMemo(() => {
  ...
  return React$14.createElement(NavigationContext.Provider, { value: navigationContext }, React$14.createElement(LocationContext.Provider, {
    children,
...
function Await({ children, errorElement, resolve }) {
  let dataRouterContext = React$14.useContext(DataRouterContext);
  let dataRouterStateContext = React$14.useContext(DataRouterStateContext);
  let onError = React$14.useCallback((error, errorInfo) => {
  ...
  return React$14.createElement(AwaitErrorBoundary, {
    resolve,
    errorElement,
    onError
  }, React$14.createElement(ResolveAwait, null, children));
}
var AwaitErrorBoundary = class extends React$14.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) return React$14.createElement(AwaitContext.Provider, {
      value: promise,
      children: errorElement
    });
    if (status === 1) return React$14.createElement(AwaitContext.Provider, {
      value: promise,
      children
    });
    throw promise;
...
function ResolveAwait({ children }) {
  ...
  return React$14.createElement(React$14.Fragment, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
  let routes = [];
  React$14.Children.forEach(children, (element, index) => {
    if (!React$14.isValidElement(element)) return;
    let treePath = [...parentPath, index];
    if (element.type === React$14.Fragment) {
...
function WithComponentProps({ children }) {
  ...
  return React$14.cloneElement(children, props);
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return React$14.createElement(HydrateFallback, props);
  };
}
...
function withErrorBoundaryProps(ErrorBoundary) {
  return function WithErrorBoundaryProps2() {
    const props = useErrorBoundaryProps();
    return React$14.createElement(ErrorBoundary, props);
  };
}

// node_modules/react-router/dist/development/lib/dom/dom.js
...
// node_modules/react-router/dist/development/lib/dom/ssr/invariant.js
function invariant2(value, message) {
  if (value === false || value === null || typeof value === "undefined") throw new Error(message);
}

// node_modules/react-router/dist/development/lib/dom/ssr/markup.js
var ESCAPE_LOOKUP = {
  "&": "\\u0026",
  ">": "\\u003e",
  "<": "\\u003c",
...
// node_modules/react-router/dist/development/vendor/turbo-stream-v2/utils.js
var Deferred2 = class {
  promise;
  resolve;
  reject;
...
// node_modules/react-router/dist/development/vendor/turbo-stream-v2/flatten.js
var TIME_LIMIT_MS = 1;
var getNow = () => Date.now();
    ...
    switch (typeof input) {
      ...
      case "object": {
        ...
        if (!pluginHandled) {
          let result = isArray ? "[" : "{";
          if (isArray) {
            for (let i2 = 0; i2 < input.length; i2++) result += (i2 ? "," : "") + (i2 in input ? flattenValue(input[i2]) : -1);
            str[index] = `${result}]`;
...
// node_modules/react-router/dist/development/vendor/turbo-stream-v2/unflatten.js
...
// node_modules/react-router/dist/development/vendor/turbo-stream-v2/turbo-stream.js
    ...
    if (Object.keys(encoder3.deferred).length) {
      ...
      while (Object.keys(encoder3.deferred).length > 0) {
        for (const [deferredId, deferred] of Object.entries(encoder3.deferred)) {
          ...
          seenPromises.add(encoder3.deferred[Number(deferredId)] = Promise.race([racePromise, deferred]).then((resolved) => {
            processingChain = processingChain.then(async () => {
              const id2 = await flatten.call(encoder3, resolved);
              if (Array.isArray(id2)) {
                controller.enqueue(textEncoder.encode(`P${deferredId}:[["Z",${id2[0]}]]
`));
                encoder3.index++;
                lastSentIndex++;
              } else if (id2 < 0) controller.enqueue(textEncoder.encode(`P${deferredId}:${id2}
`));
              else {
...
`));
            ...
            processingChain = processingChain.then(async () => {
              ...
              if (Array.isArray(id2)) {
                controller.enqueue(textEncoder.encode(`E${deferredId}:[["Z",${id2[0]}]]
`));
                encoder3.index++;
                lastSentIndex++;
              } else if (id2 < 0) controller.enqueue(textEncoder.encode(`E${deferredId}:${id2}
`));
              else {
                const values = encoder3.stringified.slice(lastSentIndex + 1).join(",");
...
// node_modules/react-router/dist/development/lib/dom/ssr/data.js
...
// node_modules/react-router/dist/development/lib/dom/ssr/single-fetch.js
...
function StreamTransfer({ context, identifier, reader, textDecoder, nonce }) {
  ...
  let scriptTag = value ? React$15.createElement("script", {
    nonce,
    dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.enqueue(${escapeHtml(JSON.stringify(value))});` }
  }) : null;
  if (done) return React$15.createElement(React$15.Fragment, null, scriptTag, React$15.createElement("script", {
    nonce,
    dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.close();` }
  }));
  else return React$15.createElement(React$15.Fragment, null, scriptTag, React$15.createElement(React$15.Suspense, null, React$15.createElement(StreamTransfer, {
    context,
...
async function singleFetchActionStrategy(args, fetchAndDecode) {
  ...
  let result = await actionMatch.resolve(async (handler) => {
    return await handler(async () => {
      let { data: data2, status } = await fetchAndDecode(args, [actionMatch.route.id]);
      actionStatus = status;
  ...
  await Promise.all(matchesToLoad.map((m) => m.resolve(async (handler) => {
    try {
      ...
      let result = hasClientLoader ? await handler(async () => {
        let { data: data2 } = await fetchAndDecode(args, [routeId]);
...
async function singleFetchLoaderNavigationStrategy(args, router, getRouteInfo, fetchAndDecode, ssr, shouldAllowOptOut = () => true) {
  ...
  if ((!router.state.initialized && router.state.navigation.state === "idle" || routesParams.size === 0) && !window.__reactRouterHdrActive) singleFetchDfd.resolve({ routes: {} });
    ...
    try {
      let data2 = await fetchAndDecode(args, targetRoutes);
...
function decodeViaTurboStream(body, global2) {
  return decode(body, { plugins: [(type, ...rest) => {
    if (type === "SanitizedError") {
      ...
      if (name && SUPPORTED_ERROR_TYPES.includes(name) && name in global2 && typeof global2[name] === "function") Constructor = global2[name];
...
// node_modules/react-router/dist/development/lib/dom/ssr/routeModules.js
...
// node_modules/react-router/dist/development/lib/dom/ssr/links.js
...
// node_modules/react-router/dist/development/lib/dom/ssr/fallback.js
var React$16 = __toESM(require_react(), 1);
function RemixRootDefaultHydrateFallback() {
  let { nonce } = useFrameworkContext();
  return React$16.createElement(BoundaryShell, {
    title: "Loading...",
    renderScripts: true
  }, React$16.createElement("script", {
    nonce,
...
// node_modules/react-router/dist/development/lib/dom/ssr/routes.js
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => React$17.createElement(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
  if (route.id === "root" && routeModule.Layout) return {
    ...Component4 ? { element: React$17.createElement(routeModule.Layout, null, React$17.createElement(Component4, null)) } : { Component: Component4 },
    ...ErrorBoundary ? { errorElement: React$17.createElement(routeModule.Layout, null, React$17.createElement(ErrorBoundary, null)) } : { ErrorBoundary },
    ...HydrateFallback ? { hydrateFallbackElement: React$17.createElement(routeModule.Layout, null, React$17.createElement(HydrateFallback, null)) } : { HydrateFallback }
  };
  return {
...
// node_modules/react-router/dist/development/lib/dom/ssr/fog-of-war.js
...
// node_modules/react-router/dist/development/lib/dom/ssr/components.js
...
var FrameworkContext = React$19.createContext(void 0);
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  ...
  let [shouldPrefetch, setShouldPrefetch] = React$19.useState(false);
  let { onFocus, onBlur, onMouseEnter, onMouseLeave, onTouchStart } = theirElementProps;
  let ref = React$19.useRef(null);
  React$19.useEffect(() => {
...
function Links({ nonce, crossOrigin }) {
  ...
  let keyedLinks = React$19.useMemo(() => getKeyedLinksForMatches(matches, routeModules, manifest), [
    matches,
    routeModules,
    manifest
  ]);
  if (nonce == null && contextNonce) nonce = contextNonce;
  return React$19.createElement(React$19.Fragment, null, typeof criticalCss === "string" ? React$19.createElement("style", {
    [CRITICAL_CSS_DATA_ATTRIBUTE]: "",
    nonce,
    dangerouslySetInnerHTML: { __html: criticalCss }
  }) : null, typeof criticalCss === "object" ? React$19.createElement("link", {
    [CRITICAL_CSS_DATA_ATTRIBUTE]: "",
    rel: "stylesheet",
    href: criticalCss.href,
    nonce,
    crossOrigin
  }) : null, keyedLinks.map(({ key, link }) => isPageLinkDescriptor(link) ? React$19.createElement(PrefetchPageLinks, {
    key,
    nonce,
    ...link,
    crossOrigin: link.crossOrigin ?? crossOrigin
  }) : React$19.createElement("link", {
    key,
    nonce,
    ...link,
    crossOrigin: link.crossOrigin ?? crossOrigin
...
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  let matches = React$19.useMemo(() => matchRoutes(router.routes, page, router.basename), [
    router.routes,
    page,
    router.basename
  ]);
  ...
  if (rsc) return React$19.createElement(RSCPrefetchPageLinksImpl, {
    page,
    matches,
    ...linkProps
  });
  return React$19.createElement(PrefetchPageLinksImpl, {
    page,
    matches,
    ...linkProps
  });
...
function RSCPrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  return React$19.createElement(React$19.Fragment, null, dataHrefs.map((href2) => React$19.createElement("link", {
    key: href2,
    rel: "prefetch",
    as: "fetch",
    href: href2,
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  let newMatchesForData = React$19.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "data"), [
    page,
    nextMatches,
    matches,
    manifest,
  ...
  let newMatchesForAssets = React$19.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "assets"), [
    page,
    nextMatches,
    matches,
    manifest,
  ...
  let moduleHrefs = React$19.useMemo(() => getModuleLinkHrefs(newMatchesForAssets, manifest), [newMatchesForAssets, manifest]);
  ...
  return React$19.createElement(React$19.Fragment, null, dataHrefs.map((href2) => React$19.createElement("link", {
    ...
    href: href2,
    ...linkProps
  })), moduleHrefs.map((href2) => React$19.createElement("link", {
    key: href2,
    rel: "modulepreload",
    href: href2,
    ...linkProps
  })), keyedPrefetchLinks.map(({ key, link }) => React$19.createElement("link", {
    key,
...
function Meta() {
  ...
  return React$19.createElement(React$19.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return React$19.createElement(Comp, {
        key: JSON.stringify(rest),
        ...rest
      });
    }
    if ("title" in metaProps) return React$19.createElement("title", { key: "title" }, String(metaProps.title));
    if ("charset" in metaProps) {
      metaProps.charSet ??= metaProps.charset;
      delete metaProps.charset;
    }
    if ("charSet" in metaProps && metaProps.charSet != null) return typeof metaProps.charSet === "string" ? React$19.createElement("meta", {
      key: "charSet",
      charSet: metaProps.charSet
    }) : null;
    if ("script:ld+json" in metaProps) try {
      let json = JSON.stringify(metaProps["script:ld+json"]);
      return React$19.createElement("script", {
    ...
    return React$19.createElement("meta", {
...
function Scripts(scriptProps) {
  ...
  let initialScripts = React$19.useMemo(() => {
...
import(${JSON.stringify(manifest.entry.module)});`;
    return React$19.createElement(React$19.Fragment, null, React$19.createElement("script", {
      ...scriptProps,
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: { __html: contextScript },
      type: void 0
    }), React$19.createElement("script", {
      ...scriptProps,
      suppressHydrationWarning: true,
  ...
  return isHydrated || isRSCRouterContext ? null : React$19.createElement(React$19.Fragment, null, typeof manifest.sri === "object" ? React$19.createElement("script", {
    ...scriptProps,
    "rr-importmap": "",
    type: "importmap",
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: { __html: JSON.stringify({ integrity: sri }) }
  }) : null, !enableFogOfWar ? React$19.createElement("link", {
    rel: "modulepreload",
    href: manifest.url,
    ...
    suppressHydrationWarning: true
  }) : null, React$19.createElement("link", {
    rel: "modulepreload",
    ...
    nonce: scriptProps.nonce,
    suppressHydrationWarning: true
  }), preloads.map((path) => React$19.createElement("link", {
    key: path,
    rel: "modulepreload",
    href: path,
    crossOrigin: scriptProps.crossOrigin,
...
// node_modules/react-router/dist/development/lib/dom/ssr/errorBoundaries.js
var React$110 = __toESM(require_react(), 1);
var RemixErrorBoundary = class extends React$110.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    if (this.state.error) return React$110.createElement(RemixRootDefaultErrorBoundary, {
...
function RemixRootDefaultErrorBoundary({ error, isOutsideRemixApp }) {
  let { nonce } = useFrameworkContext();
  console.error(error);
  let heyDeveloper = React$110.createElement("script", {
    nonce,
    dangerouslySetInnerHTML: { __html: `
        console.log(
  ...
  if (isRouteErrorResponse(error)) return React$110.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, React$110.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
  let errorInstance;
  ...
  return React$110.createElement(BoundaryShell, {
    title: "Application Error!",
    isOutsideRemixApp
  }, React$110.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), React$110.createElement("pre", { style: {
    padding: "2rem",
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
  ...
  return React$110.createElement("html", { lang: "en" }, React$110.createElement("head", null, React$110.createElement("meta", { charSet: "utf-8" }), React$110.createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1,viewport-fit=cover"
  }), React$110.createElement("title", null, title)), React$110.createElement("body", null, React$110.createElement("main", { style: {
    fontFamily: "system-ui, sans-serif",
    padding: "2rem"
  } }, children, renderScripts ? React$110.createElement(Scripts, null) : null)));
}
...
try {
  if (isBrowser2) window.__reactRouterVersion = "8";
} catch {
}
...
function BrowserRouter({ basename, children, useTransitions, window: window2 }) {
  let historyRef = React$111.useRef(null);
  ...
  let setState = React$111.useCallback((newState) => {
    if (useTransitions === false) setStateImpl(newState);
    else React$111.startTransition(() => setStateImpl(newState));
  }, [useTransitions]);
  React$111.useLayoutEffect(() => history.listen(setState), [history, setState]);
  return React$111.createElement(Router, {
    basename,
    children,
    location: state.location,
    navigationType: state.action,
...
var Link = React$111.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, mask, state, target, to, preventScrollReset, viewTransition, defaultShouldRevalidate, ...rest }, forwardedRef) {
  let { basename, navigator, useTransitions } = React$111.useContext(NavigationContext);
  ...
  let link = React$111.createElement("a", {
    ...rest,
    ...prefetchHandlers,
  ...
  return shouldPrefetch && !isAbsolute ? React$111.createElement(React$111.Fragment, null, link, React$111.createElement(PrefetchPageLinks, { page: href2 })) : link;
});
Link.displayName = "Link";
var NavLink = React$111.forwardRef(function NavLinkWithRef({ "aria-current": ariaCurrentProp = "page", caseSensitive = false, className: classNameProp = "", end = false, style: styleProp, to, viewTransition, children, ...rest }, ref) {
  let path = useResolvedPath(to, { relative: rest.relative });
  let location = useLocation();
  let routerState = React$111.useContext(DataRouterStateContext);
  let { navigator, basename } = React$111.useContext(NavigationContext);
  ...
  return React$111.createElement(Link, {
    ...rest,
...
var Form = React$111.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = "get", action, onSubmit, relative, preventScrollReset, viewTransition, defaultShouldRevalidate, ...props }, forwardedRef) => {
  ...
  let submitHandler = (event) => {
    ...
    if (useTransitions && navigate !== false) React$111.startTransition(() => doSubmit());
    else doSubmit();
  };
  return React$111.createElement("form", {
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
...
function ScrollRestoration({ getKey, storageKey, ...props }) {
  ...
  let { basename } = React$111.useContext(NavigationContext);
  let location = useLocation();
  ...
  return React$111.createElement("script", {
    ...props,
    suppressHydrationWarning: true,
...
function useLinkClickHandler(to, { target, replace: replaceProp, mask, state, preventScrollReset, relative, viewTransition, defaultShouldRevalidate, useTransitions } = {}) {
  ...
  return React$111.useCallback((event) => {
    if (shouldProcessLinkClick(event, target)) {
      ...
      if (useTransitions) React$111.startTransition(() => doNavigate());
      else doNavigate();
    }
  }, [
    location,
...
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = React$111.useRef(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = React$111.useRef(false);
  let location = useLocation();
  let searchParams = React$111.useMemo(() => getSearchParamsForLocation(location.search, hasSetSearchParamsRef.current ? null : defaultSearchParamsRef.current), [location.search]);
  let navigate = useNavigate();
  return [searchParams, React$111.useCallback((nextInit, navigateOptions) => {
...
function useSubmit() {
  ...
  return React$111.useCallback(async (target, options = {}) => {
...
function useFetcher({ key } = {}) {
  ...
  let fetcherData = React$111.useContext(FetchersContext);
  let route = React$111.useContext(RouteContext);
  ...
  let defaultKey = React$111.useId();
  let [fetcherKey, setFetcherKey] = React$111.useState(key || defaultKey);
  ...
  let load = React$111.useCallback(async (href2, opts) => {
  ...
  let submit = React$111.useCallback(async (target, opts) => {
  ...
  let reset = React$111.useCallback((opts) => resetFetcher(fetcherKey, opts), [resetFetcher, fetcherKey]);
  let FetcherForm = React$111.useMemo(() => {
    let FetcherForm2 = React$111.forwardRef((props, ref) => {
      return React$111.createElement(Form, {
        ...props,
        navigate: false,
        fetcherKey,
...
function useFetchers() {
  ...
  return React$111.useMemo(() => Array.from(state.fetchers.entries()).map(([key, fetcher]) => ({
    ...fetcher,
    key
  })), [state.fetchers]);
}
...
function useScrollRestoration({ getKey, storageKey } = {}) {
  ...
  usePageShow(React$111.useCallback((event) => {
    if (event.persisted) window.history.scrollRestoration = "manual";
  }, []));
  usePageHide(React$111.useCallback(() => {
...
// node_modules/react-router/dist/development/lib/dom/server.js
...
function StaticRouter({ basename, children, location: locationProp = "/" }) {
  ...
  return React$112.createElement(Router, {
    basename,
    children,
    location,
...
function StaticRouterProvider({ context, router, hydrate: hydrate2 = true, nonce }) {
  ...
  return React$112.createElement(React$112.Fragment, null, React$112.createElement(DataRouterContext.Provider, { value: dataRouterContext }, React$112.createElement(DataRouterStateContext.Provider, { value: state }, React$112.createElement(FetchersContext.Provider, { value: fetchersContext }, React$112.createElement(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, React$112.createElement(Router, {
    ...
    useTransitions: false
  }, React$112.createElement(DataRoutes2, {
    manifest: router.manifest,
    routes: router.routes,
    future: router.future,
    state,
    isStatic: true
  })))))), hydrateScript ? React$112.createElement("script", {
    suppressHydrationWarning: true,
    nonce,
...
// node_modules/react-router/dist/development/lib/dom/ssr/server.js
...
function ServerRouter({ context, url, nonce }) {
  ...
  return React$113.createElement(React$113.Fragment, null, React$113.createElement(FrameworkContext.Provider, { value: {
    manifest,
    routeModules,
    criticalCss,
    serverHandoffString,
  ...
  } }, React$113.createElement(RemixErrorBoundary, { location: router.state.location }, React$113.createElement(StaticRouterProvider, {
    router,
    context: context.staticHandlerContext,
    hydrate: false
  }))), context.serverHandoffStream ? React$113.createElement(React$113.Suspense, null, React$113.createElement(StreamTransfer, {
    context,
    identifier: 0,
...
// node_modules/react-router/dist/development/lib/dom/ssr/routes-test-stub.js
...
function createRoutesStub(routes, _context) {
  return function RoutesTestStub({ initialEntries, initialIndex, hydrationData, future }) {
    let routerRef = React$114.useRef(null);
    let frameworkContextRef = React$114.useRef(null);
    ...
    return React$114.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, React$114.createElement(RouterProvider, { router: routerRef.current }));
  };
}
...
// node_modules/react-router/dist/development/lib/server-runtime/crypto.js
...
function serialize(_a0, _a1, _a2) {
  ...
  const stringify3 = options?.stringify || JSON.stringify;
  const cookie = isObj ? _a0 : {
    ..._a2,
    name: _a0,
    value: _a1 == void 0 ? "" : typeof _a1 === "string" ? _a1 : stringify3(_a1)
  };
...
// node_modules/react-router/dist/development/lib/server-runtime/cookies.js
...
// node_modules/react-router/dist/development/lib/server-runtime/mode.js
...
// node_modules/react-router/dist/development/lib/server-runtime/dev.js
...
// node_modules/react-router/dist/development/lib/server-runtime/entry.js
...
// node_modules/react-router/dist/development/lib/server-runtime/errors.js
...
// node_modules/react-router/dist/development/lib/server-runtime/invariant.js
...
// node_modules/react-router/dist/development/lib/server-runtime/routeMatching.js
...
// node_modules/react-router/dist/development/lib/server-runtime/data.js
...
// node_modules/react-router/dist/development/lib/server-runtime/routes.js
...
// node_modules/react-router/dist/development/lib/server-runtime/serverHandoff.js
...
// node_modules/react-router/dist/development/lib/actions.js
...
// node_modules/react-router/dist/development/lib/server-runtime/urls.js
...
// node_modules/react-router/dist/development/lib/server-runtime/single-fetch.js
...
// node_modules/react-router/dist/development/lib/server-runtime/server.js
function derive(build, mode) {
  ...
  let requestHandler = async (request, initialContext) => {
    ...
    if (initialContext && !(initialContext instanceof RouterContextProvider)) {
      let error = new Error("Invalid `context` value provided to `handleRequest`. You must return an instance of `RouterContextProvider` from your `getLoadContext` function.");
      handleError(error);
...
// node_modules/react-router/dist/development/lib/server-runtime/sessions.js
function flash(name) {
...
// node_modules/react-router/dist/development/lib/server-runtime/sessions/cookieStorage.js
...
// node_modules/react-router/dist/development/lib/server-runtime/sessions/memoryStorage.js
...
// node_modules/react-router/dist/development/lib/href.js
function stringify2(p) {
...
function href(path, ...args) {
  ...
  let result = trimTrailingSplat(path).replace(/\/:([\w-]+)(\?)?/g, (_, param, questionMark) => {
    ...
    return value == null ? "" : "/" + encodePathParam(stringify2(value));
  });
  if (path.endsWith("*")) {
    const value = params?.["*"];
    if (value !== void 0) result += "/" + stringify2(value).split("/").map(encodePathParam).join("/");
  }
  return result || "/";
}
...
// node_modules/react-router/dist/development/lib/rsc/errorBoundaries.js
var import_react2 = __toESM(require_react(), 1);
var RSCRouterGlobalErrorBoundary = class extends import_react2.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      error: null,
  ...
  render() {
    if (this.state.error) return import_react2.default.createElement(RSCDefaultRootErrorBoundaryImpl, {
      error: this.state.error,
      renderAppShell: true
    });
    else return this.props.children;
...
function ErrorWrapper({ renderAppShell, title, children }) {
  ...
  return import_react2.default.createElement("html", { lang: "en" }, import_react2.default.createElement("head", null, import_react2.default.createElement("meta", { charSet: "utf-8" }), import_react2.default.createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1,viewport-fit=cover"
  }), import_react2.default.createElement("title", null, title)), import_react2.default.createElement("body", null, import_react2.default.createElement("main", { style: {
    fontFamily: "system-ui, sans-serif",
    padding: "2rem"
  } }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({ error, renderAppShell }) {
  console.error(error);
  let heyDeveloper = import_react2.default.createElement("script", { dangerouslySetInnerHTML: { __html: `
        console.log(
          "💿 Hey developer 👋. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
        );
      ` } });
  if (isRouteErrorResponse(error)) return import_react2.default.createElement(ErrorWrapper, {
    renderAppShell,
    title: "Unhandled Thrown Response!"
  }, import_react2.default.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
  let errorInstance;
  if (error instanceof Error) errorInstance = error;
  else {
    let errorString = error == null ? "Unknown Error" : typeof error === "object" && "toString" in error ? error.toString() : JSON.stringify(error);
  ...
  return import_react2.default.createElement(ErrorWrapper, {
    renderAppShell,
    title: "Application Error!"
  }, import_react2.default.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), import_react2.default.createElement("pre", { style: {
    padding: "2rem",
    background: "hsla(10, 50%, 50%, 0.1)",
    color: "red",
    overflow: "auto"
...
function RSCDefaultRootErrorBoundary({ hasRootLayout }) {
  ...
  return import_react2.default.createElement(RSCDefaultRootErrorBoundaryImpl, {
    renderAppShell: !hasRootLayout,
    error
  });
}

// node_modules/react-router/dist/development/lib/rsc/html-stream/server.js
...
function writeChunk(chunk, controller, nonce) {
  ...
  controller.enqueue(encoder2.encode(`<script${nonceAttr}>${escapeScript(`(self.__FLIGHT_DATA||=[]).push(${chunk})`)}<\/script>`));
}
...
// node_modules/react-router/dist/development/lib/rsc/route-modules.js
...
// node_modules/react-router/dist/development/lib/rsc/server.ssr.js
var React$115 = __toESM(require_react(), 1);
var defaultManifestPath = "/__manifest";
async function routeRSCServerRequest({ request, serverResponse, createFromReadableStream, renderHTML, hydrate: hydrate2 = true, nonce }) {
  ...
  if (hydrate2) serverResponseB = serverResponse.clone();
  ...
  try {
    ...
    if (!hydrate2) return new Response(html.pipeThrough(redirectTransform), {
      status,
      statusText,
      headers
    });
    if (!serverResponseB?.body) throw new Error("Failed to clone server response");
    const body2 = html.pipeThrough(injectRSCPayload(serverResponseB.body, { nonce })).pipeThrough(redirectTransform);
    ...
    try {
      ...
      if (!hydrate2) return new Response(html.pipeThrough(retryRedirectTransform), {
        status,
        statusText,
        headers
      });
      if (!serverResponseB?.body) throw new Error("Failed to clone server response");
      const body2 = html.pipeThrough(injectRSCPayload(serverResponseB.body, { nonce })).pipeThrough(retryRedirectTransform);
      return new Response(body2, {
        status,
        statusText,
        headers
...
function RSCStaticRouter({ getPayload, nonce }) {
  ...
  const payload = React$115.use(decoded);
  ...
  return React$115.createElement(RSCRouterContext.Provider, { value: true }, React$115.createElement(RSCRouterGlobalErrorBoundary, { location: payload.location }, React$115.createElement(FrameworkContext.Provider, { value: frameworkContext }, React$115.createElement(StaticRouterProvider, {
    context,
    router,
    hydrate: false
  }))));
...
// node_modules/react-router/dist/development/lib/dom/ssr/hydration.js
